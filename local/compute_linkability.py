...
parser.add_argument('--bins', dest='bins', type=list, nargs=1, required=False, default=[-1],   help='#Bins for linkability estimation (default is min(len(matedScores) / 10), 100))')
...
Dsys, D, bin_centers, bin_edges = linkability(matedScores, nonMatedScores, args.omega, 50)
